...
from arike.facilities.views import GenericFacilitiesView, GenericFacilityCreateView, GenericFacilityDeleteView, GenericFacilityDetailView, GenericFacilityUpdateView
...
urlpatterns = [
    ...
    path("<pk>", GenericFacilityDetailView.as_view(), name="facility_detail"),
